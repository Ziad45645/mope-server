...
public class Banana extends GameObject {
    ...
    public Banana(int id, double x, double y, int biome, Room room, Tree origin) {
        super(id, x, y, 24, 29);
    ...
    public Banana(int id, double x, double y, int biome, Room room, Animal owner, int speed, double angle) {
        super(id, x, y, 24, 29);
        this.setMovable(true);
        this.owner = owner;
