...
public class AIDuckling extends GameClient {
    ...
    public AIDuckling(Room room, LakeIsland island, AIDuck duck, double x, double y) {
        this(room);
        this.duck = duck;
        this.island = island;
        spawnAnimal(x, y);
    ...
    public void spawnAnimal(double x, double y) {
        ...
        this.egg = new Egg(this.room.getID(), x, y, this.player, this.room, this);
        this.room.addObj(this.egg);
    }

    public void evolution() {
        AIDuck duck = new AIDuck(room, this.island, this.getPlayer().getX(), this.getPlayer().getY());
        room.addAI(duck);
    ...
    public void update() {
        if (this.egg != null) {
            ...
            if (this.getPlayer() != null) {
                ...
                this.way();
                evolutionTimer.update(Constants.TICKS_PER_SECOND);
                if (evolutionTimer.isDone()) {
                    this.evolution();
                    evolutionTimer.reset();
                }
                updateRequests();
            }
        }
