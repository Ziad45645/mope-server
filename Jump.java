...
public class Jump extends Ability {
    ...
    public Jump(int id, double x, double y, int radius, Room room, double angle, Animal owner) {
        super(id, x, y, 15, radius, 0);
        this.room = room;
        this.owner = owner;
        ...
        if(this.owner.getInfo().getTier() != 3) this.owner.makeBoost(2);
    }
