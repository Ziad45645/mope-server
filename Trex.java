...
public class Trex extends Animal {
    public Trex(int id, double x, double y, AnimalInfo info, String playerName, GameClient client) {
    ...
    public void onCollision(GameObject o) {
        super.onCollision(o);
        if(getCollideableIs(o) && o instanceof Animal && ((Animal)o).getInfo().getTier() > 15 && this.biteCooldown <= 0 && !this.isInHole() && !this.flag_flying) {
        ...
        if(this.abilRunning) {
            if(stage == 0) {
                ...
                if(claw == null) {
                    ...
                    claw = new TrexShake(this.getClient().getRoom().getID(), this.getX()+x, this.getY()+y, this.getRadius(), this.getClient().getRoom(), this, this.getInfo().getAnimalSpecies());
                ...
                if(this.claw != null && this.claw.gotcha != null) {
                    ...
                    if(hurtAbilTimer.isDone()) {
                        this.claw.gotcha.hurt(20, 14, this);
    ...
    public void useAbility() {
        ...
        if(!this.isDiveMain() && !this.isDiveActive()) {
            if(abil.isPossible() && !abil.isRecharging() && abil.isUsable() && !this.abilRunning) {
                ...
                this.getClient().getRoom().sendChat(this.getClient(), "ROAR!");
                return;
            }
        } else {
        ...
        if(this.abilRunning) this.disableAbility();
    }
}
