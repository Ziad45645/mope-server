...
import io.mopesbox.Objects.ETC.WhaleTailSlap;
import io.mopesbox.Utils.Timer;
import io.mopesbox.Objects.GameObject;

public class BlueWhale extends Animal {

    public BlueWhale(int id, double x, double y, AnimalInfo info, String playerName, GameClient client) {
    ...
    public void useAbility() {
        ...
        if(abil.isPossible() && !abil.isRecharging() && abil.isUsable()) {
            ...
            WhaleTailSlap tailslap = new WhaleTailSlap(this.getClient().getRoom().getID(), this.getX()-x, this.getY()-y, ((int) Math.round(this.getRadius()/1.2)), this.getClient().getRoom(), this.getAngle(), this, this.getInfo().getAnimalSpecies());
