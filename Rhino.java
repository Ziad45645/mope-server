...
public class Rhino extends Animal {
    ...
    public Rhino(int id, double x, double y, AnimalInfo info, String playerName, GameClient client) {
        ...
        if (o instanceof Animal) {
            ...
            // }
                ...
                // if (multipl < 1)
                    ...
                    if(this.getInfo().getAnimalSpecies() == 1 && this.getInfo().getAnimalSpecies() == 2){
                        damage = damage * (int) 2.8;
                    }
