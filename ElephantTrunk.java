...
public class ElephantTrunk extends Ability {
    ...
    public ElephantTrunk(int id, double x, double y, int radius, Room room, double angle, Animal owner, int species) {
        super(id, x, y, 31, radius, 0);
        this.room = room;
        this.owner = owner;
