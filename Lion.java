...
public class Lion extends Animal {
    ...
    public String[] abilityMessage = new String[] { "Rawr!", "Roaar!" };

    public Lion(int id, double x, double y, AnimalInfo info, String playerName, GameClient client) {
    ...
    public void useAbility() {
        ...
        if (abil.isPossible() && !abil.isRecharging() && abil.isUsable()) {
            ...
            this.getClient().getRoom().sendChat(this.getClient(),
                   this.getInfo().getAnimalSubSpecies() == 2 ? "MEOW!" : "RAWR!");
            groanTimer.reset();
