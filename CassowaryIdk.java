...
public class CassowaryIdk extends Ability {
    private Timer liveTimer = new Timer(600);
    private Room room;
    ...
    public CassowaryIdk(int id, double x, double y, int radius, Room room, double angle, Animal owner, int species) {
        super(id, x, y, 73, 35, 0);
        this.room = room;
        this.owner = owner;
