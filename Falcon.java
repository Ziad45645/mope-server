...
public class Falcon extends Animal {
    public Falcon(int id, double x, double y, AnimalInfo info, String playerName, GameClient client) {
    ...
    private double step = 0;
        private Timer timeAfterPressW = new Timer(2000);
    ...
    public void onCollisionEnter(GameObject o){
        ...
        // }
            ...
            if(this.getSpecies() == 3){
                if(this.landing){
                if(o instanceof Animal && !((Animal)o).isInHole() && !((Animal)o).flag_flying && !((Animal)o).inArena && !((Animal)o).isDiveActive() && !((Animal)o).isStunned()){
                    ((Animal)o).setStun(5);
                    ((Animal)o).hurt(this.getInfo().getTier() > ((Animal)o).getInfo().getTier() ? ((Animal)o).maxHealth / 8 : ((Animal)o).maxHealth/6, 0, this);
                    this.disableAbility();
                }
                }
    ...
    public void update() {
        ...
        if(this.attacking){
            ...
            if(this.getClient().falconTarget != null && this.getClient().falconTarget.isFreezed() && !this.getClient().falconTarget.getCollidedList().contains(this)){
                            this.setMove(false);
                                            this.ability_mark = true;


            this.setMouseX(this.getClient().falconTarget.getX());
            this.setMouseY(this.getClient().falconTarget.getY());
            this.setSpecies(3);
            }
        ...
        if (this.flying) {
            ...
            if(this.getClient().falconTarget == null){
                    ...
                    this.getClient().falconTarget = new Target(this.getClient().getRoom().getID(), this.getMouseX() + 80, this.getMouseY() + 80, this.getClient(), 2, 1);
                 this.getClient().getRoom().addObj(this.getClient().falconTarget);
                                  this.getClient().falconTarget.setFreeze(false);
            }
    ...
    public void onAbilityDisable(){
        if(this.getClient().falconTarget != null){
        this.getClient().getRoom().removeObj(this.getClient().falconTarget, null);
        this.getClient().falconTarget = null;
        }
    }
    public void handleWwhenFlying(){
         if(!attacking && this.flying && this.getClient().falconTarget != null){
            this.setSpecies(2);
            attacking = true;
            this.getClient().falconTarget.setFreeze(true);
