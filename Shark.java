...
import io.mopesbox.Objects.ETC.SharkShake;
...
public class Shark extends Animal {
    public Shark(int id, double x, double y, AnimalInfo info, String playerName, GameClient client) {
        ...
        if(this.abilRunning) {
            if(stage == 0) {
                ...
                if(claw == null) {
                    ...
                    claw = new SharkShake(this.getClient().getRoom().getID(), this.getX()+x, this.getY()+y, this.getRadius(), this.getClient().getRoom(), this, this.getInfo().getAnimalSpecies(), this.getAngle());
    ...
    public void useAbility() {
        ...
        if(!this.isDiveMain() && !this.isDiveActive()) {
            if(abil.isPossible() && !abil.isRecharging() && abil.isUsable() && !this.abilRunning) {
                ...
                // this.getClient().getRoom().sendChat(this.getClient(), "EZ!");
            }
        } else {
