...
import io.mopesbox.Objects.ETC.CrocShit;
import io.mopesbox.Objects.Eatable.Meat;
import io.mopesbox.Utils.Timer;
import io.mopesbox.Utils.Utils;

public class Crocodile extends Animal {
    public Crocodile(int id, double x, double y, AnimalInfo info, String playerName, GameClient client) {
        ...
        if(this.abilRunning) {
            if(stage == 0) {
                ...
                if(claw == null) {
                    ...
                    claw = new CrocShit(this.getClient().getRoom().getID(), this.getX()+x, this.getY()+y, this.getRadius(), this.getClient().getRoom(), this, this.getInfo().getAnimalSpecies());
