...
public class HeatWave extends Ability {
    ...
    public HeatWave(int id, double x, double y, int radius, double angle, double speed, int spawnFrom, Room room, GameClient owner) {
        super(id, x, y, 104, radius, 0);
        this.room = room;
        this.speed = speed;
        this.owner = owner;
    ...
    public void onCollisionEnter(GameObject o) {
        if(o instanceof Animal && (this.owner == null || ((Animal) o) != this.owner.getPlayer()) && !((Animal) o).inArena && !((Animal) o).isInvincible() && !((Animal) o).flag_flying && !((Animal) o).isInHole() && ((Animal) o).getCollideable(this)) {
            ((Animal)o).setStun(5);
            ((Animal)o).setFire(3, this.owner != null ? this.owner.getPlayer() != null ? this.owner.getPlayer() : null : null, 3);
            ((Animal)o).addVelocityX((((Math.cos(Math.toRadians(this.mainAngle)) * (1)))));
            ((Animal)o).addVelocityY((((Math.sin(Math.toRadians(this.mainAngle)) * (1)))));
        } else if(o.isMovable() && !(o instanceof Animal)) {
            o.addVelocityX((((Math.cos(Math.toRadians(this.mainAngle)) * (2)))));
            o.addVelocityY((((Math.sin(Math.toRadians(this.mainAngle)) * (2)))));
        }
    }
    ...
    public void onCollision(GameObject o) {
        if(o instanceof Animal && (this.owner == null || ((Animal) o) != this.owner.getPlayer()) && !((Animal) o).inArena && !((Animal) o).isInvincible() && !((Animal) o).flag_flying && !((Animal) o).isInHole() && ((Animal) o).getCollideable(this)) {
            ...
            ((Animal)o).hurt(2, 0, null);
            ((Animal)o).addVelocityX((((Math.cos(Math.toRadians(this.mainAngle)) * (8)))));
            ((Animal)o).addVelocityY((((Math.sin(Math.toRadians(this.mainAngle)) * (8)))));
        }
    }
