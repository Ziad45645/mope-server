...
import io.mopesbox.Objects.ETC.SabertoothTigerJaw;
import io.mopesbox.Utils.Timer;
import io.mopesbox.Objects.GameObject;

public class SabertoothTiger extends Animal {

    public SabertoothTiger(int id, double x, double y, AnimalInfo info, String playerName, GameClient client) {
    ...
    public void useAbility() {
        ...
        if (abil.isPossible() && !abil.isRecharging() && abil.isUsable()) {
            ...
            SabertoothTigerJaw tailslap = new SabertoothTigerJaw(this.getClient().getRoom().getID(), this.getX() - x,
