...
public class LilyPad extends GameObject{
    ...
    public LilyPad(int id, double x, double y, int biome, Room room) {
        super(id, x, y, 24, 23);
        this.setMovable(true);
        this.xp = Utils.randomInt(100, 250);
        this.room = room;
        this.setBiome(biome);
    }
    ...
    public boolean getCollideable(GameObject o) {
        ...
        if(o instanceof LilyPad || o instanceof Pear || o instanceof Raspberry || o instanceof Berry || o instanceof Water) {
            return false;
        }
        return true;
    }
    ...
    public void onCollision(GameObject o) {
        super.onCollision(o);
        if(!this.isDone && getCollideableIs(o) && o instanceof Animal && ((Animal)o).getInfo().getTier() >= 5) {
