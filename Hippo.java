...
public class Hippo extends Animal {
    ...
    public String[] abilityMessage = new String[] { "GROAN!", "GROOAAN!", "Grrroooooan!" };

    public Hippo(int id, double x, double y, AnimalInfo info, String playerName, GameClient client) {
