...
public class BoaConstrictorShit extends Ability {
    ...
    public BoaConstrictorShit(int id, double x, double y, int radius, Room room, Animal owner, int species) {
        super(id, x, y, 36, radius, 0);
        this.room = room;
        this.owner = owner;
