...
import io.mopesbox.Objects.ETC.GobiBearSlash;
import io.mopesbox.Utils.Timer;

public class GobiBear extends Animal {

    public GobiBear(int id, double x, double y, AnimalInfo info, String playerName, GameClient client) {
    ...
    public void useAbility() {
        ...
        if (abil.isPossible() && !abil.isRecharging() && abil.isUsable() && !abil.isActive()) {
            ...
            GobiBearSlash tailslap = new GobiBearSlash(this.getClient().getRoom().getID(), this.getX() - x,
