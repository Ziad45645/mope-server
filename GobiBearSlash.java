...
public class GobiBearSlash extends Ability {
    ...
    public GobiBearSlash(int id, double x, double y, int radius, Room room, double angle, Animal owner, int species) {
        super(id, x, y, 82, 25, 0);
        this.room = room;
        this.owner = owner;
    ...
    public void onCollision(GameObject o) {
        ...
        if (o instanceof Animal && !damaged.contains((Animal) o) && ((Animal) o) != this.owner && !((Animal) o).inArena
            ...
            ((Animal) o).setStun(2);
            ((Animal)o).getClient().getRoom().chat(((Animal)o).getClient(), "AHHHH!");
    ...
    public void update() {
        ...
        if (liveTimer.isDone()) {
            if(owner != null && owner instanceof GobiBear){
                ((GobiBear)owner).getInfo().getAbility().setActive(false);
                }
